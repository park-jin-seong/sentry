...
export default function Settings() {
    ...
    // 토큰 표시 상태
    const [tokVer, setTokVer] = useState(0);          // 토큰 갱신 트리거
    ...
    const logToken = () => {
        ...
        console.log("[Settings] accessToken:", t || "<none>");
        if (t) console.log("[Settings] payload:", decode(t));
    };
    ...
    const onRefreshToken = async () => {
        ...
        try {
            if (api.refreshNow) {
                ...
                console.log("[Settings] refreshed (helper):", newT?.slice(0, 20) + "…");
            } else {
                ...
                console.log("[Settings] refreshed (manual):", data.accessToken.slice(0, 20) + "…");
            }
            setTokVer((v) => v + 1); // 화면 갱신
            alert("토큰이 갱신되었습니다.");
        } catch (e) {
            console.error(e);
